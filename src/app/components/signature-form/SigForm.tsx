...
import { TopicMapping, TopicOptions } from "@/app/utils/utils";
import {
  Button,
  Card,
  CardBody,
...
const SigReqValidationSchema = Yup.object<InitialValues>().shape({
  rewardCycle: Yup.number().required("Please specify the reward cycle."),
